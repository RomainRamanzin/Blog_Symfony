 ...
 */
final class Version20231102133416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, post_id INT NOT NULL, data LONGTEXT NOT NULL, INDEX IDX_FEC530A9727ACA70 (parent_id), INDEX IDX_FEC530A94B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
